            ...
            <section id="home" style={{ minHeight: 'clamp(50vh, 60vh, 75vh)', maxHeight: '100vh', background: '#000', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden', maxWidth: '100vw' }}>
                ...
                <div style={{ maxWidth: 1152, margin: '0 auto', padding: '120px 24px 80px', position: 'relative', zIndex: 1, width: '100%' }}>
                    <div style={{ maxWidth: 680, position: 'relative' }}>
                        <div className="animate-fade-in-up" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px', marginTop: 8, borderRadius: 100, background: 'rgba(251,191,36,0.1)', border: '1px solid rgba(251,191,36,0.25)', marginBottom: 32 }}>
